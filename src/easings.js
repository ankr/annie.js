/**
 * These easing functions has been obtained from easings.net
 * Thank you Andrey Sitnik and Ivan Solovev for your great work! <3
 *
 ...
 * Linear
 */
export const easeInLinear = (x) => {
  return x;
};

export const easeOutLinear = (x) => {
  return x;
};

export const easeInOutLinear = (x) => {
  return x;
};
